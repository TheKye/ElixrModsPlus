...
namespace Eco.EM.Building.Windows.PlusPack
{
    ...
    public partial class BrownGlassRecipeOverride : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(BrownGlassRecipe).Name;
    ...
    public partial class AltBrownGlassRecipeOverride : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(AltBrownGlassRecipe).Name;
        public RecipeModel Model => new()
        {
            //Required for internal referencing
