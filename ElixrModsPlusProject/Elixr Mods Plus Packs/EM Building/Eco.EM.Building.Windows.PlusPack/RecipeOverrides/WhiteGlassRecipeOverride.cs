...
namespace Eco.EM.Building.Windows.PlusPack
{
    ...
    public partial class WhiteGlassRecipeOverride : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(WhiteGlassRecipe).Name;
    ...
    public partial class AltWhiteGlassRecipeOverride : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(AltWhiteGlassRecipe).Name;
        public RecipeModel Model => new()
        {
            //Required for internal referencing
