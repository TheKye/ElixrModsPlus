...
namespace Eco.EM.Building.Windows.PlusPack
{
    ...
    public partial class PurpleGlassRecipeOverride : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(PurpleGlassRecipe).Name;
    ...
    public partial class AltPurpleGlassRecipeOverride : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(AltPurpleGlassRecipe).Name;
        public RecipeModel Model => new()
        {
            //Required for internal referencing
