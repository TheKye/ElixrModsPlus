...
namespace Eco.EM.Building.Concrete.PlusPack
{
    ...
    public partial class PaintGreenReinforcedConcreteOverrideRecipe : IRecipeOverride
    {
        //Recipe We are Overriding
        public string OverrideType => typeof(PaintGreenReinforcedConcreteRecipe).Name;
